...
# SBATCH --output={sysname}.MD002-%j.out
# SBATCH --error={sysname}.MD002-%j.err
...
# /mnt/lustre/projects/wc55/sw/vmd-1.9.2/plugins/LINUXAMD64/bin/catdcd5.1/catdcd -o {sysname}.run1.MD002.nowat.netcdf -otype netcdf -i {sysname}.nowat.ind -netcdf {sysname}.run1.MD002.netcdf
/home/briley/.local/bin/mdconvert -o {sysname}.run1.MD002.nowat.netcdf -a {sysname}.nowat.ind {sysname}.run1.MD002.netcdf


echo Create allMD.nowat.netcdf
mv {sysname}.run1.allMD.nowat.netcdf tmp.netcdf
# /mnt/lustre/projects/wc55/sw/vmd-1.9.2/plugins/LINUXAMD64/bin/catdcd5.1/catdcd -o {sysname}.run1.allMD.nowat.netcdf -otype netcdf -netcdf tmp.netcdf -netcdf {sysname}.run1.MD002.nowat.netcdf
/home/briley/.local/bin/mdconvert -o {sysname}.run1.allMD.nowat.netcdf {sysname}.run1.MD002.nowat.netcdf
rm tmp.netcdf
...
# -- 5. Run the next step.
echo Run next 50ns
sbatch MD.MonARCH.{sysname}.run1.MD003.sh
